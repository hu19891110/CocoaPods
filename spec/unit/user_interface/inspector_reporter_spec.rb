...
module Pod
  describe UserInterface::InspectorReporter do
    it 'handles inspector_started_query' do
      ...
      UI.output.should.include 'Looking for related issues on cocoapods/cocoapods'
    end
    ...
    it 'handles inspector_successfully_recieved_report' do
      ...
      UI.output.should.include 'Travis CI with Ruby 1.9.x fails for recent pull requests'
      UI.output.should.include 'https://github.com/CocoaPods/CocoaPods/issues/646 [closed] [8 comments]'
      UI.output.should.include 'pod search --full chokes on cocos2d.podspec'
    end
  end
end
